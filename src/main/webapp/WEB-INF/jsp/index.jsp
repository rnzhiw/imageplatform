...
<div id="wrapper">
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                <li class="nav-header" style="padding: 20px 25px;">
                    <div class="dropdown profile-element">
                        <span><img alt="image" style="width: 80px;height: 80px" id="image" class="img-circle" src="" /></span>
                ...
                <li>
                    <a class="J_menuItem" href="/main.do">
                ...
                <c:forEach var="menu" items="${menus}">
                    <li>
                        <a class="J_menuItem" href="${menu.menuUrl}.do">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="/main.do" frameborder="0" data-id="index_v1.html" seamless></iframe>
        </div>
        <div class="footer">
